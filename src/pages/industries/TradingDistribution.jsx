      ...
      <section className="pt-10 pb-16 lg:pt-16 lg:pb-24 overflow-hidden">
        <div className="container mx-auto px-6 sm:px-8 lg:px-10 max-w-7xl">
          <nav aria-label="Breadcrumb" className="flex items-center flex-wrap gap-2 text-sm font-medium text-muted mb-6">
            ...
            <span>/</span>
            <span className="text-navy">Trading & Distribution</span>
          </nav>
          ...
          <h1 className="text-4xl lg:text-6xl font-bold tracking-tight text-navy mb-6 leading-[1.1] max-w-4xl">
            Join up purchasing, inventory and customer orders.
          </h1>
          
          <p className="text-xl text-muted leading-relaxed mb-10 max-w-2xl">
            Trading and distribution teams depend on consistent product, supplier and stock information. Connected software can support the movement from purchase to receipt, sale and dispatch with appropriate checks at each stage.
          </p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
            ...
            <div className="flex flex-col gap-6">
              <div className="flex items-start gap-4 p-6 bg-white border border-border rounded-2xl">
                ...
                <p className="text-lg text-navy font-medium">Different versions of product and stock information</p>
              </div>
              <div className="flex items-start gap-4 p-6 bg-white border border-border rounded-2xl">
                <RefreshCw className="w-6 h-6 text-primary shrink-0 mt-1" />
                <p className="text-lg text-navy font-medium">Repeated entry between purchasing and sales systems</p>
              </div>
              <div className="flex items-start gap-4 p-6 bg-white border border-border rounded-2xl">
                <Truck className="w-6 h-6 text-primary shrink-0 mt-1" />
                <p className="text-lg text-navy font-medium">Manual follow-up on receipts, fulfilment and dispatch</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="container mx-auto px-6 sm:px-8 lg:px-10 max-w-7xl">
          <div className="max-w-3xl">
            ...
            <h2 className="text-3xl lg:text-4xl font-bold leading-tight mb-6">
              Scope a connected ERP around your transaction flow, stock locations, units, roles and reports. Integrations can be assessed for the systems you want to retain.
            </h2>
