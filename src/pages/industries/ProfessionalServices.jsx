...
import { ArrowUpRight, Folders, ClipboardList, Clock } from 'lucide-react';
      ...
      <section className="pt-10 pb-16 lg:pt-16 lg:pb-24 overflow-hidden">
        <div className="container mx-auto px-6 sm:px-8 lg:px-10 max-w-7xl">
          <nav aria-label="Breadcrumb" className="flex items-center flex-wrap gap-2 text-sm font-medium text-muted mb-6">
            ...
            <span>/</span>
            <span className="text-navy">Professional Services</span>
          </nav>
          ...
          <h1 className="text-4xl lg:text-6xl font-bold tracking-tight text-navy mb-6 leading-[1.1] max-w-4xl">
            Connect client work, team responsibilities and delivery.
          </h1>
          
          <p className="text-xl text-muted leading-relaxed mb-10 max-w-2xl">
            Professional service businesses need a clear view of commitments, documents and the next action for each engagement. Software should support the team’s working method and make hand-offs easier to manage.
          </p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
            ...
            <div className="flex flex-col gap-6">
              <div className="flex items-start gap-4 p-6 bg-white border border-border rounded-2xl">
                <Folders className="w-6 h-6 text-primary shrink-0 mt-1" />
                <p className="text-lg text-navy font-medium">Customer and project information held in separate tools</p>
              </div>
              <div className="flex items-start gap-4 p-6 bg-white border border-border rounded-2xl">
                <ClipboardList className="w-6 h-6 text-primary shrink-0 mt-1" />
                <p className="text-lg text-navy font-medium">Unclear responsibility for recurring tasks and follow-ups</p>
              </div>
              <div className="flex items-start gap-4 p-6 bg-white border border-border rounded-2xl">
                <Clock className="w-6 h-6 text-primary shrink-0 mt-1" />
                <p className="text-lg text-navy font-medium">Time spent assembling status updates from individual records</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="container mx-auto px-6 sm:px-8 lg:px-10 max-w-7xl">
          <div className="max-w-3xl">
            ...
            <h2 className="text-3xl lg:text-4xl font-bold leading-tight mb-6">
              Combine the workflows you need through custom CRM, project and task management capabilities. Start with the client journey and define how information moves across the team.
            </h2>
            <Button href="/services/crm-development" className="bg-primary text-white border-primary hover:bg-primary-hover shadow-lg shadow-primary/30 mt-4" icon={ArrowUpRight}>
