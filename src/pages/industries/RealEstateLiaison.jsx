...
import { ArrowUpRight, SearchX, BrainCircuit, EyeOff } from 'lucide-react';
import Button from '../../components/Button';
import CtaBox from '../../components/CtaBox';

const RealEstateLiaison = () => {
  return (
    <>
      {/* Page Hero */}
      <section className="pt-10 pb-16 lg:pt-16 lg:pb-24 overflow-hidden">
        <div className="container mx-auto px-6 sm:px-8 lg:px-10 max-w-7xl">
          <nav aria-label="Breadcrumb" className="flex items-center flex-wrap gap-2 text-sm font-medium text-muted mb-6">
            ...
            <span>/</span>
            <span className="text-navy">Real Estate & Liaison</span>
          </nav>
          ...
          <h1 className="text-4xl lg:text-6xl font-bold tracking-tight text-navy mb-6 leading-[1.1] max-w-4xl">
            Keep applications, documents and follow-ups in view.
          </h1>
          
          <p className="text-xl text-muted leading-relaxed mb-10 max-w-2xl">
            Property and liaison workflows often involve multiple clients, applications, documents and departments. A tailored application can help your team track the work it controls and record the status of external dependencies.
          </p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
            ...
            <div className="flex flex-col gap-6">
              <div className="flex items-start gap-4 p-6 bg-white border border-border rounded-2xl">
                <SearchX className="w-6 h-6 text-primary shrink-0 mt-1" />
                <p className="text-lg text-navy font-medium">Documents and property records difficult to retrieve</p>
              </div>
              <div className="flex items-start gap-4 p-6 bg-white border border-border rounded-2xl">
                <BrainCircuit className="w-6 h-6 text-primary shrink-0 mt-1" />
                <p className="text-lg text-navy font-medium">Application follow-ups dependent on individual memory</p>
              </div>
              <div className="flex items-start gap-4 p-6 bg-white border border-border rounded-2xl">
                <EyeOff className="w-6 h-6 text-primary shrink-0 mt-1" />
                <p className="text-lg text-navy font-medium">Limited visibility into pending work and payment tracking</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="container mx-auto px-6 sm:px-8 lg:px-10 max-w-7xl">
          <div className="max-w-3xl">
            ...
            <h2 className="text-3xl lg:text-4xl font-bold leading-tight mb-6">
              Discuss a custom application for client records, property files, approval tracking and team follow-ups. Software tracks the process; it does not guarantee an external approval outcome.
            </h2>
            <Button href="/services/custom-software-development" className="bg-primary text-white border-primary hover:bg-primary-hover shadow-lg shadow-primary/30 mt-4" icon={ArrowUpRight}>
...
export default RealEstateLiaison;
