...
import { ArrowUpRight, PackageX, FileWarning, EyeOff } from 'lucide-react';
      ...
      <section className="pt-10 pb-16 lg:pt-16 lg:pb-24 overflow-hidden">
        <div className="container mx-auto px-6 sm:px-8 lg:px-10 max-w-7xl">
          <nav aria-label="Breadcrumb" className="flex items-center flex-wrap gap-2 text-sm font-medium text-muted mb-6">
            ...
            <span>/</span>
            <span className="text-navy">Manufacturing</span>
          </nav>
          ...
          <h1 className="text-4xl lg:text-6xl font-bold tracking-tight text-navy mb-6 leading-[1.1] max-w-4xl">
            Connect the information behind every production decision.
          </h1>
          
          <p className="text-xl text-muted leading-relaxed mb-10 max-w-2xl">
            Manufacturing workflows link material availability, production activity, quality checks and dispatch. A connected application should make those relationships visible without forcing teams into unnecessary data entry.
          </p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
            ...
            <div className="flex flex-col gap-6">
              <div className="flex items-start gap-4 p-6 bg-white border border-border rounded-2xl">
                <PackageX className="w-6 h-6 text-primary shrink-0 mt-1" />
                <p className="text-lg text-navy font-medium">Purchasing and stock records disconnected from production needs</p>
              </div>
              <div className="flex items-start gap-4 p-6 bg-white border border-border rounded-2xl">
                <FileWarning className="w-6 h-6 text-primary shrink-0 mt-1" />
                <p className="text-lg text-navy font-medium">Inconsistent BOM, item or transaction definitions</p>
              </div>
              <div className="flex items-start gap-4 p-6 bg-white border border-border rounded-2xl">
                <EyeOff className="w-6 h-6 text-primary shrink-0 mt-1" />
                <p className="text-lg text-navy font-medium">Limited visibility across operational hand-offs</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="container mx-auto px-6 sm:px-8 lg:px-10 max-w-7xl">
          <div className="max-w-3xl">
            ...
            <h2 className="text-3xl lg:text-4xl font-bold leading-tight mb-6">
              A custom manufacturing ERP can be scoped around purchasing, inventory, production and reporting. Begin with one coherent operational flow and extend the modules as requirements are validated.
            </h2>
            <Button href="/services/erp-development" className="bg-primary text-white border-primary hover:bg-primary-hover shadow-lg shadow-primary/30 mt-4" icon={ArrowUpRight}>
