...
import { 
  ArrowUpRight, Contact, TrendingUp, CalendarClock, 
  ...
  return (
    <>
      <PageHeroSection 
        ...
        description="A clearer view of every customer conversation."
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            ...
            <div className="order-2 lg:order-1">
              ...
              <h2 className="text-3xl lg:text-4xl xl:text-5xl font-bold tracking-tight text-navy mb-6 leading-tight">
                A clearer view of every customer conversation.
              </h2>
              
              <p className="text-lg sm:text-xl text-muted leading-relaxed mb-8 max-w-2xl">
                A CRM is useful when it reflects how your team qualifies opportunities, follows up and moves work towards a decision. UpScala Agentix designs custom CRM workflows around your lead sources, stages and responsibilities, keeping relevant customer information accessible to authorised team members.
              </p>
            ...
            <div className="relative w-full aspect-square md:aspect-[4/3] max-w-lg mx-auto lg:ml-auto xl:max-w-none order-1 lg:order-2">
              <div className="absolute inset-0 rounded-[1.5rem] overflow-hidden">
                <img src="/hero-founder.jpg" alt="Custom CRM Development" className="w-full h-full object-cover" />
        ...
        <div className="container mx-auto px-6 sm:px-8 lg:px-10 max-w-7xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-12">
            <div className="bg-white border border-border rounded-2xl p-8 shadow-sm">
              ...
              <h3 className="text-xl font-bold text-navy mb-3">Lead and customer records</h3>
              <p className="text-muted leading-relaxed">
                Define the information your team needs and avoid unnecessary duplicate entry.
              </p>
            </div>
            ...
            <div className="bg-white border border-border rounded-2xl p-8 shadow-sm">
              ...
              <h3 className="text-xl font-bold text-navy mb-3">Sales pipeline</h3>
              <p className="text-muted leading-relaxed">
                Build stages and hand-offs that reflect how opportunities progress in your business.
              </p>
            </div>
            ...
            <div className="bg-white border border-border rounded-2xl p-8 shadow-sm">
              ...
              <h3 className="text-xl font-bold text-navy mb-3">Follow-ups and ownership</h3>
              <p className="text-muted leading-relaxed">
                Assign responsibility, track next actions and highlight overdue work.
              </p>
            </div>
            ...
            <div className="bg-white border border-border rounded-2xl p-8 shadow-sm">
              ...
              <h3 className="text-xl font-bold text-navy mb-3">Reporting and connections</h3>
              <p className="text-muted leading-relaxed">
                Connect agreed communication or operational systems and report on clearly defined pipeline measures.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
            <div>
              ...
              <p className="text-lg text-muted leading-relaxed">
                For teams with specialised sales processes, multiple hand-offs or customer data spread across personal files and messages.
              </p>
            </div>
            ...
            <div className="bg-navy rounded-[2rem] p-8 lg:p-12 text-white shadow-2xl relative overflow-hidden">
              <div className="relative z-10">
                ...
                <p className="text-white/80 leading-relaxed">
                  Potential enhancements include draft follow-up messages and customer-history summaries. Users should review generated content before it is sent.
                </p>
              </div>
            </div>
          </div>
