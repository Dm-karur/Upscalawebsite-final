  ...
  return (
    <>
      <PageHeroSection 
        ...
        description="Connect your systems. Reduce repeat entry."
        image="https://images.unsplash.com/photo-1515169061895-37fbf1156f34?q=80&w=1920&auto=format&fit=crop"
        fullScreen={true}
      />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            ...
            <div className="relative w-full aspect-square md:aspect-[4/3] max-w-lg mx-auto lg:ml-auto xl:max-w-none order-1 lg:order-2">
              <div className="absolute inset-0 rounded-[1.5rem] overflow-hidden">
                <img src="/case_studies_hero.jpg" alt="API & System Integration" className="w-full h-full object-cover" />
