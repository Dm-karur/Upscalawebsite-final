...
import { 
  ArrowUpRight, Workflow, Bell, AlertTriangle, 
        ...
        <div className="container mx-auto px-6 sm:px-8 lg:px-10 max-w-7xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-12">
            <div className="bg-white border border-border rounded-2xl p-8 shadow-sm">
              ...
              <h3 className="text-xl font-bold text-navy mb-3">Approval workflows</h3>
              <p className="text-muted leading-relaxed">
                Define approval levels, delegation and the conditions that move a request forward.
              </p>
            </div>
            ...
            <div className="bg-white border border-border rounded-2xl p-8 shadow-sm">
              ...
              <h3 className="text-xl font-bold text-navy mb-3">Notifications and reminders</h3>
              <p className="text-muted leading-relaxed">
                Identify useful alerts, escalation points and delivery channels without overwhelming users.
              </p>
            </div>
            ...
            <div className="bg-white border border-border rounded-2xl p-8 shadow-sm">
              ...
              <h3 className="text-xl font-bold text-navy mb-3">Exception handling</h3>
              <p className="text-muted leading-relaxed">
                Give teams a clear way to correct, reject or return a transaction with a recorded reason.
              </p>
            </div>
            ...
            <div className="bg-white border border-border rounded-2xl p-8 shadow-sm">
              ...
              <h3 className="text-xl font-bold text-navy mb-3">Process visibility</h3>
              <p className="text-muted leading-relaxed">
                Track pending work, completion and bottlenecks using agreed operational definitions.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
            <div>
              ...
              <p className="text-lg text-muted leading-relaxed">
                For recurring requests, document hand-offs, scheduled follow-ups and approval processes where work is frequently delayed or difficult to track.
              </p>
            </div>
            ...
            <div className="bg-navy rounded-[2rem] p-8 lg:p-12 text-white shadow-2xl relative overflow-hidden">
              <div className="relative z-10">
                ...
                <p className="text-white/80 leading-relaxed">
                  Use deterministic rules for predictable decisions. Consider AI only for tasks such as classification or summarisation, with appropriate human review.
                </p>
              </div>
            </div>
          </div>
