...
import { 
  ArrowUpRight, FileText, Search, ChartColumn, 
...
const AiIntegrationAutomation = () => {
  return (
    <>
      <PageHeroSection 
        title="AI Integration & Automation"
        description="Practical AI. A clear business purpose."
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            ...
            <div className="order-2 lg:order-1">
              ...
              <h2 className="text-3xl lg:text-4xl xl:text-5xl font-bold tracking-tight text-navy mb-6 leading-tight">
                Practical AI. A clear business purpose.
              </h2>
              
              <p className="text-lg sm:text-xl text-muted leading-relaxed mb-8 max-w-2xl">
                Useful AI starts with a specific task: finding information in approved documents, preparing a first draft or helping a team process repetitive work. UpScala Agentix helps assess the opportunity, connect the relevant data and design a workflow that keeps people in control. We distinguish a demonstrable use case from a feature that is not yet ready for daily operations.
              </p>
            ...
            <div className="relative w-full aspect-square md:aspect-[4/3] max-w-lg mx-auto lg:ml-auto xl:max-w-none order-1 lg:order-2">
              <div className="absolute inset-0 rounded-[1.5rem] overflow-hidden">
                <img src="/services_hero.jpg" alt="AI Integration & Automation" className="w-full h-full object-cover" />
                <div className="absolute inset-0 bg-gradient-to-tr from-[#0B192C]/10 to-transparent"></div>
              </div>
        ...
        <div className="container mx-auto px-6 sm:px-8 lg:px-10 max-w-7xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-12">
            <div className="bg-white border border-border rounded-2xl p-8 shadow-sm">
              ...
              <h3 className="text-xl font-bold text-navy mb-3">Document assistance</h3>
              <p className="text-muted leading-relaxed">
                Assess extraction and classification for invoices, reports or business documents, with review of uncertain results.
              </p>
            </div>
            ...
            <div className="bg-white border border-border rounded-2xl p-8 shadow-sm">
              ...
              <h3 className="text-xl font-bold text-navy mb-3">Knowledge search</h3>
              <p className="text-muted leading-relaxed">
                Help authorised users find answers in a defined set of business records and reference material.
              </p>
            </div>
            ...
            <div className="bg-white border border-border rounded-2xl p-8 shadow-sm">
              ...
              <h3 className="text-xl font-bold text-navy mb-3">Assisted reporting</h3>
              <p className="text-muted leading-relaxed">
                Prepare summaries with links back to supporting records so users can check the source.
              </p>
            </div>
            ...
            <div className="bg-white border border-border rounded-2xl p-8 shadow-sm">
              ...
              <h3 className="text-xl font-bold text-navy mb-3">Evaluation and oversight</h3>
              <p className="text-muted leading-relaxed">
                Define representative test cases, access limits, review steps and acceptable running costs before rollout.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
            <div>
              ...
              <p className="text-lg text-muted leading-relaxed">
                For teams with repeated information tasks, accessible source material and a clear way to evaluate whether AI makes the work better.
              </p>
            </div>
            ...
            <div className="bg-navy rounded-[2rem] p-8 lg:p-12 text-white shadow-2xl relative overflow-hidden">
              <div className="relative z-10">
                ...
                <p className="text-white/80 leading-relaxed">
                  AI-ready means designed to support suitable AI integrations. It does not mean every application includes AI today. Scope, provider choices and ongoing usage costs are agreed for each implementation.
                </p>
              </div>
            </div>
          </div>
...
export default AiIntegrationAutomation;
