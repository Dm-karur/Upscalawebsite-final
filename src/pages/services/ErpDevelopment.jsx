...
import { 
  ArrowUpRight, ShoppingCart, Boxes, Activity, 
  ChartColumn, ChevronDown, CodeXml, Sparkles, Workflow 
} from 'lucide-react';
  ...
  return (
    <>
      <PageHeroSection 
        ...
        description="Unify your business operations in one system."
        image="https://images.unsplash.com/photo-1531973576-1c514b8c9c0f?q=80&w=1920&auto=format&fit=crop"
        fullScreen={true}
      />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            ...
            <div className="order-2 lg:order-1">
              ...
              <h2 className="text-3xl lg:text-4xl xl:text-5xl font-bold tracking-tight text-navy mb-6 leading-tight">
                Unify your business operations in one system.
              </h2>
              
              <p className="text-lg sm:text-xl text-muted leading-relaxed mb-8 max-w-2xl">
                A custom ERP should reflect how your business buys, stores, produces, delivers and reviews work. UpScala Agentix helps define connected modules around those processes. The focus is consistent information across departments, with clear ownership of transactions and visibility into the work that needs attention.
              </p>
            ...
            <div className="relative w-full aspect-square md:aspect-[4/3] max-w-lg mx-auto lg:ml-auto xl:max-w-none order-1 lg:order-2">
              <div className="absolute inset-0 rounded-[1.5rem] overflow-hidden">
                <img src="/contact_hero.jpg" alt="Custom ERP Development" className="w-full h-full object-cover" />
        ...
        <div className="container mx-auto px-6 sm:px-8 lg:px-10 max-w-7xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-12">
            <div className="bg-white border border-border rounded-2xl p-8 shadow-sm">
              ...
              <h3 className="text-xl font-bold text-navy mb-3">Purchasing and suppliers</h3>
              <p className="text-muted leading-relaxed">
                Design requisition, quotation, purchase-order and receipt workflows around your approval rules.
              </p>
            </div>
            ...
            <div className="bg-white border border-border rounded-2xl p-8 shadow-sm">
              ...
              <h3 className="text-xl font-bold text-navy mb-3">Inventory and movement</h3>
              <p className="text-muted leading-relaxed">
                Track materials, units, locations and stock transactions with the controls your team needs.
              </p>
            </div>
            ...
            <div className="bg-white border border-border rounded-2xl p-8 shadow-sm">
              ...
              <h3 className="text-xl font-bold text-navy mb-3">Operations and costing</h3>
              <p className="text-muted leading-relaxed">
                Connect projects or production activities with the resources and transactions behind them.
              </p>
            </div>
            ...
            <div className="bg-white border border-border rounded-2xl p-8 shadow-sm">
              ...
              <h3 className="text-xl font-bold text-navy mb-3">Management reporting</h3>
              <p className="text-muted leading-relaxed">
                Agree report definitions, drill-downs and access before building the dashboards.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
            <div>
              ...
              <p className="text-lg text-muted leading-relaxed">
                For businesses whose operational processes cross multiple departments and require more control than a collection of separate tools provides.
              </p>
            </div>
            ...
            <div className="bg-navy rounded-[2rem] p-8 lg:p-12 text-white shadow-2xl relative overflow-hidden">
              <div className="relative z-10">
                ...
                <p className="text-white/80 leading-relaxed">
                  Explore document extraction or assisted reporting after transaction data and review controls are reliable. AI outputs should not silently create financial transactions.
                </p>
              </div>
            </div>
          </div>
